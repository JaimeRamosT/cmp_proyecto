...
public:
  ...
  virtual int visit(DoWhileStatement* e) = 0;     // DW
  virtual int visit(ForStatement* e) = 0;
  virtual int visit(BreakStatement* e) = 0;       // B/C
  virtual int visit(ContinueStatement* e) = 0;    // B/C
